...
<head>
    ...
    <title>Edit Kelas | Pembayaran SPP</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo BASE_URL . '/admin/kelas/proses_edit.php?id=' . $id ?>" method="post">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="input-group mb-3 col-md-6">
                                                <input type="text" class="form-control" name="kompetensi_keahlian" placeholder="Kompetensi Keahlian" value="<?php echo $kelas['kompetensi_keahlian'] ?>">
                                            </div>

...
<head>
    ...
    <title>Edit SPP | Pembayaran SPP</title>
                        ...
                        <div class="col-12">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="<?php echo BASE_URL . '/admin/spp/proses_edit.php?id=' . $id ?>" method="post">

                                        <div class="row">

                                            <div class="input-group mb-3 col-md-6">
                                                <input type="text" class="form-control" name="tahun" value="<?php echo $spp['tahun'] ?>">
                                            </div>

                                            <div class="input-group mb-3 col-md-6">
                                                <input type="text" class="form-control" name="nominal" value="<?php echo $spp['nominal'] ?>">
                                            </div>

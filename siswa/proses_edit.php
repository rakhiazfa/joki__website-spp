...
$new_id_kelas = $id_kelas === '' ? $id_kelas['id_kelas'] : $id_kelas;
$new_alamat = $alamat === '' ? $alamat['alamat'] : $alamat;
$new_no_telp = $no_telp === ''? $no_telp['no_telp'] : $no_telp;

$query = mysqli_query($koneksi, "UPDATE siswa 
SET nama = '$new_nama', nisn = '$new_nisn', nis = '$new_nis', id_kelas = '$new_id_kelas', alamat = '$new_alamat' 
WHERE nisn = '$nisn'");
...
if (mysqli_affected_rows($koneksi) > 0) {
    ...
    echo "
        <script>
            ...
            window.location.href = '" . BASE_URL . "/siswa/edit.php?nisn=$nisn';
        </script>
    ";
} else {
